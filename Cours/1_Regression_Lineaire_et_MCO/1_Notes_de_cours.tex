...
Dans ces premières notes de cours nous revenons sur l'estimateur des moindres carrés pour le modèle de 
régression linéaire étudié en économétrie 1: ses propriétés et 
les méthodes courantes d'inférence qui lui sont associées dans un 
cadre non-asymptotique(i.e., à distance finie). Avant cela on s'intéresse aux interprétations du modèle.
